        ...
        <div class="authentication-inner py-5">
            ...
            <form class="card" action="javascript:;" method="POST">
                <div class="p-4 p-sm-5">
                    ...
                    <div class=" text-center mb-2"><i class="feather icon-alert-circle" style="font-size: 40px; color:red;"></i></div>
                    <h3 class="text-center">Access Denied!</h3>
                    <h6 class="text-center">Please login your account to access this link</h6>
                </div>
            </form>
            <!-- [ Form ] End -->
