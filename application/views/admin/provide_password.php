        ...
        <div class="authentication-inner py-5">
            ...
            <?php }else{ ?>
                ...
                <div class="p-4 p-sm-5">
                    ...
                    <p>Please login your account to access the link.</p>
                    <div class="form-group">
                    ...
                    <button type="button" class="btn btn-primary btn-block" onclick="submitLogin()">Submit</button>
                </div>
            </form>
...
<!-- Created JS -->
    ...
    <script type="text/javascript">
        ...
        function submitPassword(){
            ...
            $.ajax({
                    url: base_url+'Admin/submit_password',
                    type: 'POST',
                    data: {
                        password: $("#passwordADV").val(),
        ...
        function submitLogin(){
            ...
            $.ajax({
                    url: base_url+'Admin/submit_login',
                    type: 'POST',
                    data: {
                        email: $("#email").val(),
